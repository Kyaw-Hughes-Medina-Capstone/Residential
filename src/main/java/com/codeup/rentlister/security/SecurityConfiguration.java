    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/home", "/", "/property", "/property/*", "/sign-up", "/login", "/property/create", "/property/*/edit", "/property/show", "property/*/inquiry", "property/workorder", "tenant/lease", "tenant/move-in", "tenant/index", "KXZ-logo.png", "residentialLease.pdf", "/filtered-properties", "/static/js/map.js", "/property/*/review", "/contact").permitAll()
